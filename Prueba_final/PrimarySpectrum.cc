...
{
    particlePosition = G4ThreeVector(0., 0., 400.*cm); // Aquí modifico para la posición inicial de la partícula.
...
void PrimarySpectrum::primaryMomento()
{
    ...
    //particlePosition = G4ThreeVector(x * m, y * m, z * m); // Actualiza la posición de la partícula
