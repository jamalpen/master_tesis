...
```bash
docker run -it --env="LIBGL_ALWAYS_SOFTWARE=1"  --name my_geant4   --net=host   --env="DISPLAY" --device /dev/dri  -v $HOME/.Xauthority:/root/.Xauthority:rw   -v ${HOME}/Geant4_Simulations:/home/geant4lab/Geant4_projects   jpenafiell/geant4-v10.7.3:latest
```
